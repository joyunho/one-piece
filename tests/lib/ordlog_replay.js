...
const RUNS=Object.freeze([
  ...
  // "이번엔 죽었어 보잡이 부족했" — 네코마무시 유령 마딜 보잡 크레딧이
  // 화면 '충족'을 만들었던 패배(v19.9.2 교정의 원 판).  외부 점검 지적대로
  // 데이터만 있고 등재가 빠져 있었다.
  {key:'0801L',file:'ORD_2305_20260801_034446_active.ordlog.json',outcome:'loss'},
  ...
  // v19.11.1 데스크톱 셸 첫 실전 — 빅맘 단끝(25라 확정) 패배(~58라).
  // 사인: 31라에 이감 79/117로 정착한 뒤 (1) 이감 후보 전부 제작 불가인데
  // 회복 목표가 ACT_NOW 에서 계산되지 않아 노리기 안내 0, (2) "0선위를
