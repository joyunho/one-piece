...
assert(/<meta name="ord-helper" content="v16\.0\.0-decision-engine">/.test(helper),'v16.0.0 helper marker missing');
...
assert.strictEqual(C.VERSION,'16.0.0');
assert.strictEqual(planner.VERSION,'16.0.0');
assert.strictEqual(typeof planner.planFinalSquad,'function');
assert.strictEqual(context.ORDV15Engine.VERSION,'16.0.0');
...
assert(/<meta name="ord-helper" content="v16\.0\.0-decision-engine-manual">/.test(manual),'manual build marker missing');
