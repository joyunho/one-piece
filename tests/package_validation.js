...
const required=[
  ...
  'ord_upper_memo.js','ord_synergy_memo.js','ord_data_patch.js','ord_story_nonupper_data.js','ord_story_upper_data.js','ord_upper_combat_data.js','ord_core.js',
...
assert.strictEqual(manifest.version,'17.0.0');
...
assert(/<meta name="ord-helper" content="v17\.0\.0-decision-engine">/.test(helper),'v17.0.0 helper marker missing');
...
for(const file of ['ord_units_data.js','ord_upper_memo.js','ord_synergy_memo.js','ord_data_patch.js','ord_story_nonupper_data.js','ord_story_upper_data.js','ord_upper_combat_data.js','ord_core.js','ord_squad_planner.js','ord_v15_model.js','ord_v15_ledger.js','ord_v15_policy.js','ord_v15_engine.js']){
...
assert.strictEqual(planner.VERSION,'17.0.0');
assert.strictEqual(typeof planner.planFinalSquad,'function');
assert.strictEqual(context.ORDV15Engine.VERSION,'17.0.0');
...
assert(/<meta name="ord-helper" content="v17\.0\.0-decision-engine-manual">/.test(manual),'manual build marker missing');
...
assert.strictEqual(manualScripts,17,'manual inline script count changed');
for(const file of ['ord_units_data.js','ord_upper_memo.js','ord_synergy_memo.js','ord_data_patch.js','ord_story_nonupper_data.js','ord_story_upper_data.js','ord_upper_combat_data.js','ord_core.js','ord_squad_planner.js','ord_v15_model.js','ord_v15_ledger.js','ord_v15_policy.js','ord_v15_engine.js','ord_run_log_compactor.js','ord_run_log.js','ord_app.js']){
