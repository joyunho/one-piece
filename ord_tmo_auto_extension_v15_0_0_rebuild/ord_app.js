...
class App{
  ...
  act(a,b){
    ...
    if(a==='dismiss-onboarding'){this._onboardingOpen=false;this.state.onboardingSeen=true;this.persist();this.render();return;}
  ...
  renderV238Onboarding(){
    ...
    const steps=[
      ...
      ['4','인게임','F8 = 게임 위 HUD(클릭 통과) · F9 = 미니 패널(끌어서 위치 지정 — F8도 그 자리를 씁니다) · F10 = 다른 모니터로 이동. 판이 끝나면 결과(클리어/패배)를 입력해 주세요 — 코치가 판마다 배웁니다.']
    ];
