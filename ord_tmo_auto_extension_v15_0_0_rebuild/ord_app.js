...
class App{
  ...
  authoritativeDecision(settings){
    ...
    if(key!==this._v15CacheKey){
      ...
      catch(error){this._v15Cache={version:'17.12.1',authority:true,state:'SYNC_BLOCKED',label:'판단 엔진 점검 필요',reason:String(error&&error.message||error),action:null,alternatives:[],unknowns:['판단 엔진 오류']};}
