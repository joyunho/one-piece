(function () {
  ...
  function ensureBadge() {
    ...
    card.className = 'card';
    card.innerHTML = '<div class="top"><span class="title">ORD 실전 판단 코치 v26.1.0</span><span class="dot"></span></div><div class="meta">수집 대기 중 · TMO.GG 데스크톱 프로그램을 먼저 실행하세요</div><button class="btn">실전 코치 열기</button>';
