...
const outputPath = path.join(packageDir, 'ord_2305_nightmare_helper_v17_12_1_manual.html');
const staleOutputs = [
...
<head>
  ...
  <meta name="ord-helper" content="v17.12.1-decision-engine-manual">
  <meta name="description" content="현재 패의 정확한 순차 원장과 생존 마감으로 다음 한 행동만 결정하는 원랜디 2.305 악몽 수동 도우미">
  <title>원랜디 2.305 악몽 실전 판단 코치 v17.12.1 · 수동 모드</title>
