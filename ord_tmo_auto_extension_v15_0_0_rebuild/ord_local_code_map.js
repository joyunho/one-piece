(function (global) {
  ...
  //  · 배제 — PA0H 는 판 내내 상수 1 상수 궤적 위양성으로 무시 유지.
  //    Y50h 는 v23.0 에서 배제 해제: 2312 카탈로그가 Y50h 를 '고대의 배'
  //    (unit_1767884970331_9084)의 codes 로 직접 확정했다 — 카탈로그 직결이
  //    무시 목록보다 권위가 높다.
  ...
  var IGNORE_CODES = RESOURCE_CODES.concat([
    ...
    // 상수 단독 코드 — DOM 상대 없음
    '4C0H', 'A70h', 'A80h', 'C80h', 'JA0h', 'M50H', 'Q60h', 'R60h', 'S60h', 'U50h',
